...
namespace Launcher
{
    class RRcode
    {
        ...
        public static int NahodneCisloVyroku()
        {
            Random random = new Random();
            return random.Next(1, 1114);
        }

        public static string Vyrok(int iPoradie, bool Autor)
        {
            ...
            switch (iPoradie)
            {
                ...
                case 131:
                    if (Autor == false)
                    {
                        return "Dobre využitý čas robí čas ešte oveľa drahocennejším.";
                    }
                    else
                    {
                ...
                case 132:
                    if (Autor == false)
                    {
                        return "Dobrí ľudia svoj hnev dlho neživia.";
                    }
                    else
                    {
                        return "Publius Syrus";
                ...
                case 133:
                    if (Autor == false)
                    {
                        return "Dobu neobviňuj, keď si príčinou žiaľu.";
                    }
                    else
                    {
                        return "Cato";
                ...
                case 1033:
                    if (Autor == false)
                    {
                        return "Zmija vyzlieka kovu, ale srdce si necháva.";
                    }
                    else
                    {
                ...
                case 1087:
                    if (Autor == false)
                    {
                        return "Kde bol predtým oheň, tam môžeme nájsť žeravé uhlíky.";
                    }
                    else
                    {
                        return "Francúzske príslovie";
                ...
                case 1096:
                    if (Autor == false)
                    {
                        return "Veľa múdreho pochádza predsa už aj od žien.";
                    }
                    else
                    {
                        return "Euripides";
                ...
                case 1101:
                    if (Autor == false)
                    {
                        return "Lenivosť je strach pred očakávanou prácou.";
                    }
                    else
                    {
                        return "Cicero";
                ...
                case 1111:
                    if (Autor == false)
                    {
                        return "Liana sa šplhá vysoko len s pomocou stromu.";
                    }
                    else
                    {
        ...
        public static void CopyPro(string sFilename, string sDirectory, System.ComponentModel.ISynchronizeInvoke oThis)
        {
    ...
    class RRvar
    {
        ...
        private static string _sCopyFileVersion;
        public static string sCopyFileVersion
        {
            get
            {
                return _sCopyFileVersion;
            }
            set
            {
                _sCopyFileVersion = value;
            }
        }
        
        
        private static bool _bCopyFileProgress;
        public static bool bCopyFileProgress
        {
            get
            {
                return _bCopyFileProgress;
            }
            set
            {
                _bCopyFileProgress = value;
            }
        }
